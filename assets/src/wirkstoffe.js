...
|-------|---------|----------|----------|----------|
| **X** | 1st level | anatomical main group | **Alimentary tract and metabolism**  | ${stats['1']}
| **X00**	| 2nd level | therapeutic subgroup | **Drugs used in diabetes** | ${stats['3']}
| **X00X** | 3rd level | pharmacological subgroup | **Blood glucose lowering drugs, excl. insulins** | ${stats['4']}
| **X00XX** | 4th level | chemical subgroup | **Biguanides** | ${stats['5']}
| **X00XX00** | 5th level | chemical substance | **Metformin** | ${stats['7']}
