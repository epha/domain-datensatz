...
Total: ${stats.type2.amount}

${table(sort(stats.type2.values))}

### type3

Total: ${stats.type3.amount}

${table(sort(stats.type3.values))}

### type4

Total: ${stats.type4.amount}

${table(sort(stats.type4.values))}

### type5

Total: ${stats.type5.amount}
