...
then
  ...
  aws --region eu-central-1 s3 sync --delete assets/ s3://epha.io/datensatz/assets/ --exclude .DS_Store
  aws --region eu-central-1 s3 sync --delete data/ s3://epha.io/datensatz/data/ --exclude .DS_Store
...
then
  ...
  aws --region eu-central-1 s3 sync --delete assets/ s3://epha.ch/datensatz/assets/ --exclude .DS_Store
  aws --region eu-central-1 s3 sync --delete data/ s3://epha.ch/datensatz/data/ --exclude .DS_Store
